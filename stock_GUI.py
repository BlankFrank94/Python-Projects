...
class StockApp:
    def __init__(self):
        ...
        # Create Window
        self.root = Tk()
        self.root.title("Frank's Stock Manager")
      
        # Add Menu
        self.menubar = Menu(self.root)
        
        # File Menu
        self.filemenu = Menu(self.menubar, tearoff=0, bg="blue", fg="white", activebackground="lightblue", activeforeground="white")
        # self.filemenu.add_command(label="Import CSV...")
        self.menubar.add_cascade(label="File", menu=self.filemenu)
        
        # Web Menu
        self.webmenu = Menu(self.menubar, tearoff=0, bg="blue", fg="white", activebackground="lightblue", activeforeground="white")
        ...
        #Chart Menu
        self.chartmenu = Menu(self.menubar,tearoff=0, bg="blue", fg="white", activebackground="lightblue", activeforeground="white")
